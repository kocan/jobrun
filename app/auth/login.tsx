      ...
      <View style={styles.inner}>
        ...
        {sent ? (
          <View style={styles.successBox}>
            ...
            <Pressable accessibilityRole="button" accessibilityLabel="Tap to activate action" style={styles.retryButton} onPress={() => setSent(false)}>
        ...
        <Pressable accessibilityRole="button" accessibilityLabel="Tap to activate action" style={styles.skipButton} onPress={skipAuth}>
